...
contract wtfsolidity_safe is Test {
    ...
    //forge test --match-test  testAmmAttack  -vv
    function testAmmAttack() public {
        // 添加流动性之前的价格
        ...
        // 添加流动性
         weth.approve(address(amm), amountA);
         dai.approve(address(amm), tokenbOut);
       (uint amountAr, uint amountBr, uint liquidityr) = amm.addLiquidity(WETH,DAI,amountA, tokenbOut);
       //   添加流动性成功的代币 
